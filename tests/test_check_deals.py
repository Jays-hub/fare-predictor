...
def test_truncated_cycle_still_checks_blocked_itineraries_but_skips_stale():
    # Simulates a partly-blocked cycle. DEN got the freshest snapshot (22:00);
    # MCO was blocked then but its last good price is only 14h old (still fresh);
    # LAS has been blocked long enough that its latest price is 46h stale.
    rows = [
        # DEN: deal in the freshest cycle -> checked.
        _raw("2026-06-25T22:00:00+00:00", "DEN", "Delta", 200),
        _raw("2026-06-26T22:00:00+00:00", "DEN", "Delta", 210),
        _raw("2026-06-27T22:00:00+00:00", "DEN", "Delta", 205),
        _raw("2026-06-28T22:00:00+00:00", "DEN", "Delta", 150),
        # MCO: latest is 06-28T08:00 (14h before panel newest) -> fresh, deal.
        _raw("2026-06-25T08:00:00+00:00", "MCO", "Delta", 200),
        _raw("2026-06-26T08:00:00+00:00", "MCO", "Delta", 210),
        _raw("2026-06-27T08:00:00+00:00", "MCO", "Delta", 205),
        _raw("2026-06-28T08:00:00+00:00", "MCO", "Delta", 150),
        # LAS: latest is 06-27T00:00 (46h before panel newest) -> stale, skipped
        # even though the drop would otherwise qualify.
        _raw("2026-06-23T00:00:00+00:00", "LAS", "Frontier", 200),
        _raw("2026-06-24T00:00:00+00:00", "LAS", "Frontier", 210),
        _raw("2026-06-25T00:00:00+00:00", "LAS", "Frontier", 205),
        _raw("2026-06-27T00:00:00+00:00", "LAS", "Frontier", 150),
    ]
    deals = D.find_deals(_mins(rows))
    assert set(deals["dest"]) == {"DEN", "MCO"}   # blocked-but-fresh MCO included
    assert "LAS" not in set(deals["dest"])         # stale price suppressed
